    ...
    <div className="flex flex-col gap-6">
      <div className="bg-card border border-white/5 rounded-2xl p-6">
        ...
        {audioFile || initialAudioUrl ? (
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              {audioFile ? (
                ...
                <Button
                  ...
                  className="text-primary hover:text-foreground shrink-0 text-xs gap-1"
                >
          ...
          >
            <div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center mb-3 group-hover:bg-primary/20">
      ...
      <div className="bg-card border border-white/5 rounded-2xl p-6">
        ...
        {imagePreview ? (
          ...
          <div
            ...
            className="aspect-square w-full max-w-[240px] mx-auto border-2 border-dashed border-white/10 rounded-xl flex flex-col items-center justify-center cursor-pointer hover:border-primary/50 hover:bg-primary/5 transition-all group"
          >
