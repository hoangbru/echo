    ...
    <div className="flex flex-col md:flex-row gap-4 items-center bg-card p-4 rounded-xl border border-white/5 mb-8">
      <div className="relative flex-1 w-full">
        ...
        <input
          ...
          className="w-full bg-background border border-white/10 rounded-lg pl-10 pr-4 py-2 text-sm text-white focus:border-primary outline-none"
        />
      </div>
      ...
      <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto">
        ...
        <div className="flex items-center gap-2 flex-1 md:flex-none">
          ...
          <select
            ...
            className="w-full md:w-[160px] bg-background border border-white/10 rounded-lg px-4 py-2 text-sm text-white focus:border-primary outline-none cursor-pointer"
          >
