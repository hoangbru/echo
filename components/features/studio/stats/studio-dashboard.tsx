...
export function StudioDashboard() {
  ...
  if (authLoading || statsLoading) {
    return <StudioDashboardSkeleton />;
  }
        ...
        <div className="lg:col-span-2 bg-card border border-border rounded-[var(--radius)] p-[24px] flex flex-col">
          <div className="flex justify-between items-center mb-[24px]">
            ...
            <select
              ...
              className="bg-background border border-border rounded-[4px] px-3 py-1.5 text-[13px] text-muted-foreground focus:outline-none focus:border-primary cursor-pointer hover:text-foreground transition-colors"
            >
