...
export function DashboardSidebar({
  ...
  return (
    <aside
      className={cn(
        "fixed inset-y-0 left-0 z-50 w-64 bg-sidebar border-r border-border transition-transform lg:relative lg:translate-x-0 flex flex-col",
    ...
    >
      ...
      <div className="p-4 border-t border-border shrink-0">
        <Button
          variant="outline"
          className="w-full gap-2 border-border text-muted-foreground hover:bg-accent hover:text-foreground rounded-xl transition-colors"
          asChild
        >
