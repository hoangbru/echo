  ...
  return (
    <header className="bg-card border-b border-white/10 px-6 py-4 flex items-center justify-between sticky top-0 z-20">
      ...
      <div className="relative flex items-center gap-4" ref={menuRef}>
        ...
        >
          <div className="relative h-10 w-10 rounded-full ring-2 ring-primary/50 overflow-hidden flex-shrink-0 transition-all group-hover:ring-primary shadow-[0_0_10px_rgba(236,72,153,0.2)]">
